...
import org.ebics.schema.h004.EbicsRequestDocument.EbicsRequest.Body.TransferReceipt;
...
import org.ebics.schema.h004.EbicsUnsecuredRequestDocument.EbicsUnsecuredRequest.Body.DataTransfer.OrderData;
import org.ebics.schema.h004.EbicsUnsecuredRequestDocument.EbicsUnsecuredRequest.Header;
...
import org.ebics.schema.h004.TransactionPhaseType.Enum;
...
public class EbicsXmlFactory {
   ...
   * @param pubKeyValue the <code>org.ebics.schema.h004.PubKeyValueType</code> element
   * @param x509Data the <code>X509DataType</code> element
  ...
  public static AuthenticationPubKeyInfoType createAuthenticationPubKeyInfoType(String authenticationVersion,
                                                                                org.ebics.schema.h004.PubKeyValueType pubKeyValue,
  ...
  /**
   * Creates a new <code>org.ebics.schema.h004.PubKeyValueType</code> XML object
   * @param rsaKeyValue the <code>RSAKeyValueType</code> element
   * @param timeStamp the current time stamp
   * @return the <code>org.ebics.schema.h004.PubKeyValueType</code> XML object
   */
  public static org.ebics.schema.h004.PubKeyValueType createh004PubKeyValueType(RSAKeyValueType rsaKeyValue, Calendar timeStamp) {
    org.ebics.schema.h004.PubKeyValueType newPubKeyValueType = org.ebics.schema.h004.PubKeyValueType.Factory.newInstance();
    newPubKeyValueType.setRSAKeyValue(rsaKeyValue);
    newPubKeyValueType.setTimeStamp(timeStamp);
  ...
  /**
   * Creates a new <code>org.ebics.schema.h004.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> XML object
   * @param authenticate should authenticate?
   * @param mutable the <code>EmptyMutableHeaderType</code> element
   * @param xstatic the <code>NoPubKeyDigestsRequestStaticHeaderType</code> element
   * @return the <code>org.ebics.schema.h004.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> XML object
   */
  ...
  /**
   * Creates a new <code>org.ebics.schema.h004.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body</code> XML object
   * @return the <code>org.ebics.schema.h004.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body</code> XML object
   */
  ...
  /**
   * Creates a new <code>org.ebics.schema.h004.EbicsRequestDocument.EbicsRequest.Header</code> XML object
   * @param authenticate should authenticate?
   * @param mutable the <code>MutableHeaderType</code> element
   * @param xstatic the <code>StaticHeaderType</code> element
   * @return the <code>org.ebics.schema.h004.EbicsRequestDocument.EbicsRequest.Header</code> XML object
   */
  ...
  /**
   * Create the <code>org.ebics.schema.h004.EbicsRequestDocument.EbicsRequest.Body</code> XML object
   * @param dataTransfer the <code>DataTransferRequestType</code> element
   * @return the <code>org.ebics.schema.h004.EbicsRequestDocument.EbicsRequest.Body</code> XML object
   */
  ...
  /**
   * Create the <code>DataTransferRequestType</code> XML object
   * @param orderData the <code>org.ebics.schema.h004.DataTransferRequestType.OrderData</code> element
   * @return the <code>DataTransferRequestType</code> XML object
   */
  ...
  /**
   * Create the <code>org.ebics.schema.h004.DataTransferRequestType.OrderData</code> XML object
   * @param orderDataValue the order data value
   * @return the <code>org.ebics.schema.h004.DataTransferRequestType.OrderData</code> XML object
   */
   ...
   * @return the the <code>org.ebics.schema.h004.DataTransferRequestType.OrderData</code> XML object
   */

...
interface KeyManagement {
    ...
    fun sendINI(ebicsSession: EbicsSession)
    ...
    fun sendHIA(ebicsSession: EbicsSession)
    ...
    fun sendHPB(ebicsSession: EbicsSession, password: String): BankCertificateManager
     ...
     */
    @Throws(IOException::class, EbicsException::class)
    fun lockAccess(ebicsSession: EbicsSession)
}